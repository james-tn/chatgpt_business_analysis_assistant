...
from base_tool import SQL_Query, ChatGPT_Handler
...
faq_dict = {  
    "ChatGPT": [  
        "Show me daily revenue trends in 2016 across product categories. Please a category dropdown filter for the chart.",  
